...
For my main browser, I have moved from Firefox to Brave. Main reason was that it has many of the base features that I expect from a browser baked-in, while in Firefox I had to download extensions to get those functionalities (like ad-blocking). Brave supports all these out of the box. Also, Brave search and Leo have worked better compared to DuckDuckGo for me.
...
Now, Brave also has "Cycle through the most recently used tabs with Ctrl-Tab", but by no means it's close to what Firefox provides: There is no preview and it also [messes up](https://github.com/brave/brave-browser/issues/12840) the PageUp/Down navigation.
...
![1786306714971-cycle-overlay.png](/images/1786306714971-cycle-overlay.png)You can easily go to the previous tab by pressing Ctrl + backtick. There's also a search feature. This was all I needed.

There are some corner cases, like you can't use it on a new tab, but this is good enough for me.

[Here's](https://mru-tabs.arashtaher.com/) the webpage for it. Approval in Chrome web store is still pending.
