...
- On the server side: Figure out why handling the connections fails (context deadline exceeded? time out?). Also, make sure you're [reading the response bodies before closing them]({{% ref "2025-11-04-closing-responses-in-golang.md" %}}).
