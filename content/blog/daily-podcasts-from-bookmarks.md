...
This is the new feature that I added to my bookmarking solution, Pensive[1]: It will look at all the articles I've read the day before, and create a podcast for me from that. A perfect listen to get me "in the mood for work".
...
- Organizing content in a structured directory-based system. Doing this, we will have the chance to also create a wiki from all your readings - Inspired by "LLM Knowledge Bases" tweet from Andrej[4]
- Capturing content from YouTube and Podcasts.
- Adding a TIL section. Right now I'm using Memo[5] and I want to bring it to Pensive
...
[1] https://getpensive.com
[2] https://github.com/hexgrad/kokoro
[3] https://danielmiessler.com/blog/google-is-getting-left-behind-due-to-horrible-ui-ux
[4] https://x.com/karpathy/status/2039805659525644595
[5] https://github.com/usememos/
